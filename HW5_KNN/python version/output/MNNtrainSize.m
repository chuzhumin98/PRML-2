...
set(AX(1),'yTick',[0:100:500])  %设置左边Y轴的刻度 
set(AX(2),'yTick',[0.6:0.1:1.0]) %设置右边Y轴的刻度
set(AX(1),'ylim',[0 520])  %设置左边Y轴的刻度 
set(AX(2),'ylim',[0.6 1.0]) %设置右边Y轴的刻度
xlim([0.5 size+0.5])
